...
button_subtract = Button(root , text = "-" , padx = 39 , pady = 20 , command = buttonsub)
button_multi = Button(root , text = "×" , padx = 39 , pady = 20 , command = buttonmultiply)
button_div = Button(root , text = "/" , padx = 39 , pady = 20 , command = buttondivide)
...
button_quit.grid(row = 7 , columnspan=3)
